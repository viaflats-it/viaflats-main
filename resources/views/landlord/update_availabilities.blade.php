					...
					<form>
						...
						<div>
							...
							<div class="form-group" style="display:inline-block;">
								<button id="showhideall" style="display:inline;float: left" class="dropdown-toggle btn btn-viaflats" data-toggle="dropdown">@lang('landlord.btnshow')</button>
							</div>
						</div>
						...
						<div class="form-group" style="display:inline-block; width:100%; text-align: center;">
							<button id="fillall" style="display:none; float:left;" class="dropdown-toggle btn btn-viaflats" data-toggle="dropdown">@lang('landlord.fillall')</button>
							<button id="clearall" style="display:none; float:right;" class="dropdown-toggle btn btn-viaflats" data-toggle="dropdown">@lang('landlord.clearall')</button>
						</div>
						<div>
